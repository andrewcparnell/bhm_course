...
A glossary of terms for the course _Introduction to Bayesian Hierarchical Modelling'
...
- __Hyper-parameter__: A top level parameter that depends on no other parameters in a hierarchical model
