...
- None of the package we will use in this course (e.g. JAGS and Stan) create $p$-values

## Summary 

- Choosing a probability distribution is hard. For the data sets we use I will try to give you lots of choices
