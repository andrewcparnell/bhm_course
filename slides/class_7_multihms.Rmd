...
- Mathematically you can write out the estimated mean of the parameters as a weighted average of the group means ($\alpha_j$) and the overall mean ($\mu_\alpha$) where the weights are dependent on the group and overall variance and sample sizes. 
