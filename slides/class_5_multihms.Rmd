---
title: 'Class 5: Multivariate and multi-layer hierarchical models'
...
model{
  ...
  # Priors
  for(j in 1:N_eth) {
    beta_eth[j] ~ dnorm(0, sigma_eth^-2)
  }
  beta_height ~ dnorm(0, 20^-2)
  alpha ~ dnorm(0, 20^-2)
...
- In JAGS it is absolutely trivial to to deal with missingness in the response variable. You simple fill in the missing values with `NA`
