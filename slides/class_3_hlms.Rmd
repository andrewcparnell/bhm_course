...
plot(y_sim_summary[2,], log(dat$earn), 
...
- Suppose now we want to see if there was a ethnicity effect on the relationship between height and earnings
- Some possible choices:
    ...
    - Add ethnicity in as an interaction, this will lead to a _varying slopes_ model
