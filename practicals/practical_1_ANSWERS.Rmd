---
title: 'Day 1 ANSWER SCRIPT: Self-guided practical  - Using R for linear regression and GLMs'
...
1. Another data set which is worth fitting a linear regression model to is the `geese_isotopes.csv` data. You might like to see if one of the isotope values is affected by some of the other variables (sex, adult, etc)
